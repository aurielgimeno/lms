	...
	<div class="no-gutter row">
      		...
      		<div class="col-md-12" id="content">
            	<div class="panel">
				      		...
				      		<div class="col-md-12" id="content">
            	<div class="panel">
    			<div class="panel-heading" style="background-color:#111;color:#fff;">ABOUT SCHOOL</div>   
              	<div class="panel-body">
                  
                  <div class="row">
                  <div class="col-md-12">
                    <h2>Gordon Height National High School, Learning Management System</h2>
						This is a sample paragraph for the website.
						This is a sample paragraph for the website.
						This is a sample paragraph for the website.
						This is a sample paragraph for the website.
						This is a sample paragraph for the website.
