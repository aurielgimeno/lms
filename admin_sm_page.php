                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                             <i class="fa fa-fw fa-wrench"></i>System Manager
                        </h1>
					...
					<div class="col-lg-8">
                        <div class="panel panel-default">
                            ...
                            <div class="panel-body">
								<button class="btn btn-lg btn-primary">Add School Year</button>
								<button class="btn btn-lg btn-primary">Add Month Quarter</button>
                            </div>
                        </div>
                    </div>
